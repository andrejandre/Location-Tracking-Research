# -*- coding: utf-8 -*-
"""
Created on Mon Apr 15 16:09:12 2019
...
d = [time, xAcc, yAcc, zAcc, xVel, yVel, zVel, xDis, yDis, zDis]
export_data = zip_longest(*d, fillvalue = '')
with open('BigSquare_integrated.csv', 'w', newline='') as myfile:
      wr = csv.writer(myfile)
      wr.writerow(('time', 'x Accel', 'y Accel', 'z Accel', 'x Vel', 'y Vel', 
                   'z Vel', 'x Dis', 'y Dis', 'z Dis'))
